...
public abstract class BaseCtl<F extends BaseForm, T extends BaseDTO, S extends BaseServiceInt<T>> {
	...
	public void setUserContext(HttpSession session) {
		System.out.println("Inside BaseCtl setUserContext --");
	...
	public ORSResponse get() {
		System.out.println("Inside BaseCtl Get() method run");
	...
	public ORSResponse delete(@PathVariable long id) {
		System.out.println("Inside BaseCtl Delete() method run........");
		ORSResponse res = new ORSResponse(true);
		try {
	...
	public ORSResponse deleteMany(@PathVariable String[] ids, @RequestParam("pageNo") String pageNo,
			@RequestBody F form) {
		System.out.println("Inside BaseCtl DeleteMany() method....... ");
		ORSResponse res = new ORSResponse(true);
		try {
			...
			for (String id : ids) {
				System.out.println("Inside BaseCtl Deletemany() Records To be Deleted :: " + id);
			...
			System.out.println("Inside BaseCtl Deletemany() Records Deleted Successfully");
	...
	public ORSResponse save(@Valid @RequestBody F form, BindingResult bindingResult) {
		System.out.println("Inside Basectl 228save() run in BaseCtl " + form);
