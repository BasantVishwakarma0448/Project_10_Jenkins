...
var HttpServiceService = /** @class */ (function () {
    ...
    HttpServiceService.prototype.isLogout = function () {
        ...
        if ((JSESSIONID == "null" || JSESSIONID === null) && (this.router.url != "/login"
            ...
            console.log("Basant Vishwakarma");
            return true;
        }
        else {
            return false;
...
var MarksheetmeritListComponent = /** @class */ (function (_super) {
    ...
    MarksheetmeritListComponent.prototype.goToLink = function () {
        window.open('assets/jasper/MarksheetMeritPro10.jrxml', '_blank');
    };
...
module.exports = __webpack_require__(/*! C:\Users\basan\OneDrive\Desktop\Pro10\Project10\ORSProject10-UI\src\main.ts */"./src/main.ts");
